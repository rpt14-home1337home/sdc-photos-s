    ...
    <div className="full-description-box">
      <div className="left-description-box">
        ...
        <div className="room-description">
          Sit back in a private plunge pool and enjoy an uninterrupted vista of Table Mountain, the city skyline, and the ocean beyond. The views are just as good from inside this chic and modern penthouse, where sunlight pours in through walls of windows.
        </div>
      </div>
      ...
      <div className="right-description-box">
        ...
        <div className="review-photo-description-box">
          <img src="http://pbs.twimg.com/profile_images/1002272769352978433/9S4QWSR0_400x400.jpg" alt="review-picture" className="review-picture"/>
          <svg viewBox="0 0 14 24" role="img" className="review-picture-medal">
            <path d={one} fill="#fff"/>
            <path d={two} fill="#ffb400"/>
            <path d={three} fill="#ff5a5f"/>
            <path d={four} fill="#484848"/>
          </svg>
        </div>

        <div className="review-commentary-box">
          <div className="quote-comment">"Airbnb's most wish-listed listing in South Africa"</div>
