  ...
  return (
    <div className="left-description-box">
      ...
      <div className="room-description">
        Sit back in a private plunge pool and enjoy an uninterrupted vista of
        Table Mountain, the city skyline, and the ocean beyond. The views are
        just as good from inside this chic and modern penthouse, where sunlight
        pours in through walls of windows.
      </div>
    </div>
  );
};
